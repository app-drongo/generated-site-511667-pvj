...
// Generated: 2025-08-20T16:48:16.382Z
// Section: cta
// Category: cta
...
export default function CTA() {
  const stats = [
    ...
    { value: "100+", label: "Open Banking Integrations", icon: Zap },
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join the leading businesses that are transforming their financial
                operations with our cutting-edge open banking platform. Start
                your free trial today and experience the future of finance.
              </p>
